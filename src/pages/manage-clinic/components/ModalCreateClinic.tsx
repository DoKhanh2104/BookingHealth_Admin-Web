...
import type { ClinicRequestPayload } from '../ManageClinic.types';

interface ModalCreateClinicProps {
  open: boolean;
  onClose: () => void;
  onConfirm: (payload: ClinicRequestPayload) => void;
}

const ModalCreateClinic = ({ open, onClose, onConfirm }: ModalCreateClinicProps) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    // Parse to float for longitude and latitude
  ...
  const handleConfirm = () => {
    ...
    setFormData({ name: '', address: '', longitude: undefined, latitude: undefined });
    setErrors({});
  };
